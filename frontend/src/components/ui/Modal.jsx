  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={cn(
          'modal-panel flex max-h-[calc(100vh-2rem)] w-full flex-col rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-floating)]',
          sizeClasses[size]
        )}
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="shrink-0 flex items-center justify-end gap-3 border-t border-[var(--color-border)] px-6 py-4">
            {footer}
          </div>
        )}
      </div>
