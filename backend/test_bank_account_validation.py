...
def test_validate_and_normalize_bank_accounts_accepts_legacy_banco_nacion_11_digits():
    methods = [
        {
            "tipo": "bank",
            ...
            "cci": "01812301234567890123",
        }
    ]

    normalized = validate_and_normalize_bank_accounts(methods)

    assert normalized[0]["cuenta"] == "12345678901"
    assert normalized[0]["cci"] == "01812301234567890123"
